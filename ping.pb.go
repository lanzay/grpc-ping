...
type PingMsg struct {
	...
	Type    MsgType `protobuf:"varint,4,opt,name=type,proto3,enum=main.MsgType" json:"type,omitempty"`
}
...
func (x *PingMsg) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *PingMsg) GetType() MsgType {
	if x != nil {
		return x.Type
	}
	return MsgType_Ping
...
func (x *PongMsg) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *PongMsg) GetType() MsgType {
	if x != nil {
		return x.Type
	}
	return MsgType_Ping
...
var file_ping_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x22, 0x69, 0x0a, 0x07, 0x50, 0x69, 0x6e, 0x67, 0x4d, 0x73, 0x67, 0x12, 0x0e, 0x0a,
	...
	,
}
...
var file_ping_proto_goTypes = []interface{}{
	(MsgType)(0),    // 0: main.msg_type
	(*PingMsg)(nil), // 1: main.PingMsg
	(*PongMsg)(nil), // 2: main.PongMsg
}
var file_ping_proto_depIdxs = []int32{
	0, // 0: main.PingMsg.type:type_name -> main.msg_type
	0, // 1: main.PongMsg.type:type_name -> main.msg_type
	1, // 2: main.Pinger.Ping:input_type -> main.PingMsg
	2, // 3: main.Pinger.Ping:output_type -> main.PongMsg
